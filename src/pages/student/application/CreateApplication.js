                ...
                <div style={formContainerStyle}>
                    ...
                    >
                        ...
                        <Row gutter={[16, 0]}>
                            ...
                            <Col xxl={9} xl={10} lg={10} md={12} sm={12} xs={24}>
                        ...
                        {academicSections.map((section, index) => (
                            <div key={index}>
                                <Row gutter={[24, 0]}>
                                    ...
                                    <Col xxl={8} xl={8} lg={8} md={12} sm={21} xs={21}>
                                        ...
                                        >
                                            <Upload
                                                ...
                                                multiple={false}
                                            >
                                                {section.certificate && section.certificate.length > 0 ? null : (
